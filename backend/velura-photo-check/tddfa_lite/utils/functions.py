...
# matplotlib is only needed by the two visualization helpers below
# (plot_image / draw_landmarks); imported lazily inside them so the
# pose-only path (crop_img / parse_roi_box_* / calc_hypotenuse) doesn't
# require matplotlib as a hard dependency in a production service.
